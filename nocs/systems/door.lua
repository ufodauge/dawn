...
---@param e {door: ECS.DoorComponent, animation: ECS.AnimationComponent, color: ECS.ColorComponent, transform: ECS.TransformComponent, circle: ECS.CircleComponent, physics: ECS.PhysicsComponent}
---@param dt number
function System:process(e, dt)
    ...
    for _, contact in ipairs(contacts) do
        ...
        if (cat_a == CATEGORY.PLAYER and cat_b == CATEGORY.DOOR and fix_b == e.physics.fixture or
            cat_b == CATEGORY.PLAYER and cat_a == CATEGORY.DOOR and fix_a == e.physics.fixture) then
